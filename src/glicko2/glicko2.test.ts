import { Outcome, Player, Race, Team } from './'
...
describe('Glicko 2 Player', () => {
  describe('Players', () => {
    ...
    // Create the players
    let P1 = new Player(1500, 200, 0.06, 0.5, 1500)
    let P2 = new Player(1400, 30, 0.06, 0.5, 1500)
    let P3 = new Player(1550, 100, 0.06, 0.5, 1500)
    let P4 = new Player(1700, 300, 0.06, 0.5, 1500)
    ...
    it('should add results without affecting rating', () => {
      // Add the matches
      P1.addResult(P2, Outcome.WIN)
        .addResult(P3, Outcome.LOSS)
        .addResult(P4, Outcome.LOSS)
